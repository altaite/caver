...
/**
 * Identifies residue in context of PDB file. Defines alphabetical oredering
...
public class ResidueId implements Comparable<ResidueId>, Serializable {
    ...
    /**
     * Serial number is a string (maybe hexa number) in Gromacs. This is against
     * PDB file format guide, but we need to read PDB files produced by Gromacs.
     */
    ...
    public boolean equals(Object o) {
        ...
        boolean b = insertion_ == id.insertion_ && number_.equals(id.number_);
        return b;
    }
    ...
    public int compareTo(ResidueId id) {
        ...
        if (0 != chainComparison) {
            ...
            if (0 != numberComparison) {
                ...
                return new Character(insertion_).compareTo(id.insertion_);
            }
        }
    }
}
